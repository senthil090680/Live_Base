...
<div class="mcf"></div>
<div><h2 align="center">DEVICE STATUS</h2></div> 
<div id="containerdaily">

<span style="float:right;"><input type="button" name="kdproduct" value="Close" class="buttons" onclick="window.location='../include/empty.php'"></span>

<div class="clearfix"></div>
 <div id="search">
	<input type="text" name="DSR_name" id="DSR_name" value="<?php echo $_REQUEST['DS1R_name']; ?>" autocomplete='off' placeholder='Search By SR/DSR Name'/>
	<input type="button" class="buttonsg" onclick="searchdevstatusajax('<?php echo $Page; ?>');" value="GO"/>
 </div>
 <div class="clearfix"></div>        
        <div id="devicestatusid">
		<div class="con">
        <table width="100%">
		<thead>
		<tr>
