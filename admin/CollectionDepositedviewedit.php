...
<!--<span style="float:left;"><input type="button" name="kdproduct" value="Add Collection Deposit" class="buttonsbig" onclick="window.location='CollectionDeposited.php'"></span>-->
