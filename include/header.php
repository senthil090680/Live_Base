...
if($_SESSION["loggedIn"] != true) {
    echo("Access denied! Your Not a logged user");
    exit();
}
...
<li><a href="#">Base Master Data </a>
        ...
        <ul>
       	...
       	<li><a href="../BaseMaster/srincentive_br.php" title="">Brand Target</a></li>
  ...
  <li><a href="#">DSR Stock & Sale </a>
    <ul>
             ...
             <ul>     
                    ...
                    <li><a href="../admin/CollectionDepositedviewedit.php">Collection Deposit</a></li>
