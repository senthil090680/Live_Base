...
if(isset($_REQUEST[fromdatevalue]) && $_REQUEST[fromdatevalue] !='') {
	...
	*/
	...
	$query_target												=   "SELECT KD_Code,SR_Code,productive_percent,prod_status,monthval,yearval FROM coverage_target_setting $target_query ORDER BY SR_Code";
	//echo $query_target;
	//exit;
	...
	foreach($finalSearchInfo as $val_focussold)	{
		...
		if($focusactInfo[$INDEX_VAL][FOCUS_ID]	==	$INDEX_VAL) {
			...
			if($finalSearchInfo[$i]["PRO_TGT"] == 0) {
				$finalSearchInfo[$i]["PRO_ACT"]				=   round($finalSearchInfo[$i]["SALES_Count"]/$finalSearchInfo[$i]["visit_Count"]);
			} else {				
				$finalSearchInfo[$i]["PRO_ACTVISIT"]		=   round($finalSearchInfo[$i]["SALES_Count"]/$finalSearchInfo[$i]["visit_Count"]);
	...
	<thead>
	  <tr>
		...
		<th align="center" style="width:10%">Productivity %
		 <table  width="100%"><tr><td align="center">Target</td><td align="center">Actual</td></tr></table>
		</th>
	...
	?>
	 <tr>
		 ...
		 //echo $checkfor ."==" .$checkoutfor."<br>"; ?> Sub Total<strong></td>
			 ...
			 <td align="center" style="width:10%;padding:0px;">
			 <table width="100%" border="0">
				<tr>
					<td align="right" style="padding:0px;width:15px;"><?php //echo $k . "+++++" . $arrcnt."<br/>"; echo $checkfor ."==" .$checkoutfor."<br>"; ?> <?php echo $tot_prod_tgt; ?></td>
					<td align="right" style="padding:0px;width:15px;"><?php echo $tot_prod_act; ?></td>
				</tr>
			 </table>
			 </td>	
			 ...
			 <table width="100%">
				<tr>
					<td align="right" style="padding:0px;width:15px;"> <?php //echo $k . "+++++" . $arrcnt."<br/>"; echo $checkfor ."==" .$checkoutfor."<br>"; ?> <?php echo $tot_focus_inplan; ?></td>
					<td align="right" style="padding:0px;width:15px;"><?php echo $tot_focus_sold; ?></td>
				</tr>
			 </table>
			 </td>	
			 <td align="center" style="width:10%;padding:0px;">
				&nbsp;<?php echo $tot_drop; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<?php echo $tot_bas; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<?php echo $tot_focus_cov; ?>
				<!-- <table width="100%" border="1">
					<tr>
						<td align="right" class="metalign"> <?php //echo $k . "+++++" . $arrcnt."<br/>"; echo $checkfor ."==" .$checkoutfor."<br>"; ?> <?php echo $tot_drop; ?></td>
						<td align="right" class="metalign"><?php echo $tot_bas; ?></td>
						<td align="right" class="focalign"><?php echo $tot_focus_cov; ?></td>
					</tr>
				</table> -->
			 </td>
  </tr>
...
<tr >
	 ...
	 <td align="right" <?php if($reportby == 'DateVal') { ?> style="background-color:#31859C;" <?php } ?>><?php echo $SearchVal[DateVal]; ?></td>
	 ...
	 <td align="center" style="width:10%;padding:0px;">
	 <table width="100%"><tr><td align="right" style="padding:0px;width:15px;"> <?php //echo $k . "+++++" . $arrcnt."<br/>"; echo $checkfor ."==" .$checkoutfor."<br>"; ?> <?php echo $SearchVal[PRO_TGT]; ?></td><td align="right" style="padding:0px;width:15px;"><?php echo $SearchVal[PRO_ACT]; ?></td></tr></table>
	 </td>	
	 <td align="right"><?php echo number_format($SearchVal[Sale_Value],2); ?></td>	
	 <td align="right"><?php echo $SearchVal[SALES_Count]; ?></td>	
	 <td align="right"><?php echo $SearchVal[Invoice_Line_Count]; ?></td>	
	 <td align="center" style="width:10%;padding:0px;">
	 <table width="100%"><tr><td align="right" style="padding:0px;width:15px;"> <?php //echo $k . "+++++" . $arrcnt."<br/>"; echo $checkfor ."==" .$checkoutfor."<br>"; ?> <?php echo $SearchVal[FOCUS_ACTUAL]; ?></td><td align="right" style="padding:0px;width:15px;"><?php echo $SearchVal[FOC_CNT]; ?></td></tr></table>
	 </td>	
	 <td align="center" style="width:10%;padding:0px;">
		<?php echo $SearchVal[Drop_Value]; ?>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<?php echo $SearchVal[Basket_Value]; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<?php echo $SearchVal[FOCUS_COV]; ?>
		<!-- <table width="100%" border="0">
			<tr>
				<td align="right" class="metalign"> <?php //echo $k . "+++++" . $arrcnt."<br/>"; echo $checkfor ."==" .$checkoutfor."<br>"; ?> <?php echo $SearchVal[Drop_Value]; ?></td>
				<td align="right" class="metalign"><?php echo $SearchVal[Basket_Value]; ?></td>
				<td align="right" class="focalign"><?php echo $SearchVal[FOCUS_COV]; ?></td>
			</tr>
		</table> -->
	  </td>	
 ...
 <tr>
	 ...
	 <td align="right"><?php echo $tot_sal_vis; ?></td>	
	 <td align="center" style="width:10%;padding:0px;">
	 <table width="100%" border="0"><tr><td align="right" style="padding:0px;width:20px;"> <?php //echo $k . "+++++" . $arrcnt."<br/>"; echo $checkfor ."==" .$checkoutfor."<br>"; ?> <?php echo $tot_prod_tgt; ?></td><td align="right" style="padding:0px;width:20px;"><?php echo $tot_prod_act; ?></td></tr></table>
	 </td>	
	 <td align="right"><?php echo number_format($tot_sales,2); ?></td>	
	 <td align="right"><?php echo $tot_invoice; ?></td>	
	 <td align="right"><?php echo $tot_line_items; ?></td>	
	 <td align="center" style="width:10%;padding:0px;">
	 <table width="100%" border="0"><tr><td align="right" style="padding:0px;width:15px;"> <?php //echo $k . "+++++" . $arrcnt."<br/>"; echo $checkfor ."==" .$checkoutfor."<br>"; ?> <?php echo $tot_focus_inplan; ?></td><td align="right" style="padding:0px;width:15px;"><?php echo $tot_focus_sold; ?></td></tr></table>
	 </td>	
	 <td align="center" style="width:10%;padding:0px;" >
		<?php echo $tot_drop; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<?php echo $tot_bas; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 ...
 <tr >
	 ...
	 <td align="center" style="width:10%;padding:0px;">
		<table width="100%">
			<tr>
				<td align="right" style="padding:0px;width:20px;"><?php //echo $k . "+++++" . $arrcnt."<br/>"; echo $checkfor ."==" .$checkoutfor."<br>"; ?><?php echo $total_prod_tgt; ?></td>
				<td align="right" style="padding:0px;width:20px;"><?php echo $total_prod_act; ?></td>
			</tr>
		</table>
	 </td>	
	 ...
	 <td align="center" style="width:10%;padding:0px;">
		<table width="100%">
			<tr>
				<td align="right"><?php //echo $k . "+++++" . $arrcnt."<br/>"; echo $checkfor ."==" .$checkoutfor."<br>"; ?> &nbsp;&nbsp;<?php echo $total_focus_inplan; ?>&nbsp;&nbsp;</td>
	 ...
	 <td style="width:10%;padding:0px;">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $total_drop; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<?php echo $total_bas; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<?php echo $total_focus_cov; ?>

		<!-- <table width="100%" cellpadding='0'>
			<tr>
				<td class="metalign" align="right"><?php //echo $k . "+++++" . $arrcnt."<br/>"; echo $checkfor ."==" .$checkoutfor."<br>"; ?> <?php echo $total_drop; ?></td>
				<td class="metalign" align="right"><?php echo $total_bas; ?></td>
				<td class="focalign" align="right"><?php echo $total_focus_cov; ?></td>
			</tr>
		</table> -->
	 </td>
 </tr>
...
<span id="printopen" style="padding-left:470px;padding-top:10px;<?php if($num_rows > 0 ) { echo "display:block;"; } else { echo "display:none;"; } ?>" ><input type="button" name="kdproduct" value="Print" class="buttons" onclick="print_pages('printsrperformajax');" />
<!-- <button name="kdproduct" class="buttons" onclick="print_pages('printsrperformajax');" >Print</button> -->
<!-- <a class="buttons" onclick="print_pages('printsrperformajax');" >Print</a> -->
</span>
<form name="printsrperformajax" id="printsrperformajax" target="_blank" action="printsrperformajax.php" method="post">
