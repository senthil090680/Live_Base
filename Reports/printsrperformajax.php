...
<style type="text/css">
  ...
  <table border="1" width="100%" class="tablecls" style="border-collapse:collapse;">
...
<th align="left" colspan="16" style="height:30px;"><?php echo "From Date : &nbsp;&nbsp;&nbsp;".$fromdatevalue."&nbsp;&nbsp;&nbsp;&nbsp;To Date : &nbsp;&nbsp;&nbsp;".$todatevalue."&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;"; ?></th>		
	  ...
	  <tr>
		...
		<th align="center" >Focus Items
			<table  width="100%">
				<tr>
					<td align="center">In Plan</td>
					<td align="center">Sold</td>
				</tr>
			</table>
		</th>
		<th align="center" style="width:200px;">Metrics
			<table  width="100%">
				<tr>
					<td align="center">Dr Sz</td>
					<td align="center">Bas Sz</td>
					<td align="center">Fcs Cvg</td>
				</tr>
			</table>
		</th> 
  </tr>
...
?>
<tr>
	 <td <?php if($reportby == 'DSR_Name') { ?>  <?php } ?>><?php echo ucwords(strtolower($SearchVal[DSR_Name])); ?></td>
	 <td align="right" <?php if($reportby == 'DateVal') { ?>  <?php } ?>><?php echo $SearchVal[DateVal]; ?></td>
	 ...
	 <td align="center">
		<table width="100%">
			<tr>
				<td align="right" ><?php echo $SearchVal[EFF_TGT]; ?></td>
	 ...
	 <td align="center" >
		<table width="100%" border="0">
			<tr>
				<td align="right" ><?php echo $SearchVal[FOCUS_ACTUAL]; ?></td>
