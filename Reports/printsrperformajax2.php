	...
	foreach($finalSearchInfo as $val_target)	{
		...
		if($targetInfo[$INDEX_VAL]	==	$INDEX_VAL) {
			...
			if($targetUnits[$INDEX_VAL]["effective_status"][$monthvalue.$monthyeararrval[0]] == '5') {
				$finalSearchInfo[$i]["EFF_TGT"]					=   $targetUnits[$INDEX_VAL]["effective_percent"][$monthvalue.$monthyeararrval[0]];
	...
	foreach($finalSearchInfo as $val_focussold)	{
		...
		if($focusactInfo[$INDEX_VAL][FOCUS_ID]	==	$INDEX_VAL) {
			...
			if($finalSearchInfo[$i]["EFF_TGT"] == 0 || $finalSearchInfo[$i]["EFF_TGT"] == 0 || $finalSearchInfo[$i]["EFF_TGT"] == '') {
				$finalSearchInfo[$i]["EFF_ACT"]				=   round($finalSearchInfo[$i]["EFF_Count"]);
			} else {				
				$finalSearchInfo[$i]["EFF_ACTVISIT"]		=   round($finalSearchInfo[$i]["EFF_Count"]);
...
<div class="condaily_routeplan">
  <table border="1" width="100%" class="tablecls">
	<thead class="theadcls">
		<tr>
			<th align="center" colspan="16" style="height:30px;">SR PERFORMANCE REPORT</th>
		</tr>
		<tr >
			<th align="left" colspan="16" style="height:30px;"><?php echo "From Date : &nbsp;&nbsp;&nbsp;".$fromdatevalue."&nbsp;&nbsp;&nbsp;&nbsp;To Date : &nbsp;&nbsp;&nbsp;".$todatevalue."&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;"; ?></th>		
		</tr>
	  <tr>
		...
		<th align="center" >Focus Items
			<table  width="100%">
				<tr>
					<td align="center"><strong>In Plan</strong></td>
					<td align="center"><strong>Sold</strong></td>
				</tr>
			</table>
		</th>
		<th align="center" style="width:260px;">Metrics
			<table  width="100%">
				<tr>
					<td align="center"><strong>Dr Sz</strong></td>
					<td align="center"><strong>Bas Sz</strong></td>
					<td align="center"><strong>Fcs Cvg</strong></td>
				</tr>
			</table>
		</th> 
  </tr>
		   ...
		   <td align="right"><?php echo $tot_hours; ?></td>	
			 ...
			 <td align="center" style="width:210px;">
				<table width="100%" class="tablefixed">
					<tr>
						<td align="right"><?php //echo $k . "+++++" . $arrcnt."<br/>"; echo $checkfor ."==" .$checkoutfor."<br>"; ?> <?php echo number_format($tot_drop,2); ?></td>
						<td align="right"><?php echo number_format($tot_bas,2); ?></td>
						<td align="right"><?php echo number_format($tot_focus_cov,2); ?></td>
					</tr>
				</table>
			 </td>
	  </tr>
...
<tr>
	 ...
	 <td align="center" style="width:210px;">
		<table width="100%" class="tablefixed">
			<tr>
				<td align="right"><?php //echo $k . "+++++" . $arrcnt."<br/>"; echo $checkfor ."==" .$checkoutfor."<br>"; ?><?php echo number_format($SearchVal[Drop_Value],2); ?></td>
				<td align="right"><?php echo number_format($SearchVal[Basket_Value],2); ?></td>
				<td align="right"><?php echo number_format($SearchVal[FOCUS_COV],2); ?></td>
			</tr>
		</table>
	  </td>	
 ...
 <tr>
	 ...
	 <td align="center">
		<table width="100%" border="0">
			<tr>
				<td align="right"><?php //echo $k . "+++++" . $arrcnt."<br/>"; echo $checkfor ."==" .$checkoutfor."<br>"; ?><?php echo $total_prod_tgt; ?></td>
	 ...
	 <td align="center" style="width:260px;">
		 <table width="100%" class="tablefixed">
			<tr>
				<td align="right"><?php //echo $k . "+++++" . $arrcnt."<br/>"; echo $checkfor ."==" .$checkoutfor."<br>"; ?><?php echo number_format($total_drop,2); ?></td>
				<td align="right"><?php echo number_format($total_bas,2); ?></td>
