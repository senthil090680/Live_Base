...
<div id="mainarea">
<div class="mcf"></div>
<div><h2 align="center">Scheme</h2></div> 
...
<!--<span style="float:left;">&nbsp;&nbsp;<input type="button" value="Back" class="buttons" onclick="window.location='dsr.php'"></span>-->
 <div id="search" style="padding-right:200px">
        <input type="text" name="Scheme_Description" value="<?php echo $_REQUEST['Scheme_Description']; ?>" autocomplete='off' placeholder='Search By Scheme Des'/>
        <input type="button" class="buttonsg" onclick="schemesearch('<?php echo $Page; ?>');" value="GO"/>
 </div>
 <div class="clearfix"></div>
			<div id="schid">
