...
function srviewajaxsearch(page){  // For pagination and sorting of the SR search in view page
...
#containerpr {
	...
	<div class="con">
			...
			<tr>
				...
				<th nowrap="nowrap" class="rounded" onClick="srviewajax('<?php echo $Page;?>','<?php echo $paramsval; ?>');">SR Name<img src="../images/sort.png" width="13" height="13" /></th>
				<th nowrap="nowrap">SR Code</th>
