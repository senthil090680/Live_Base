...
<div id="mainarea">
<div class="mcf"></div>
<div><h2 align="center">Product Scheme Master</h2></div> 
...
<span style="float:left;">&nbsp;&nbsp;&nbsp;<input type="button" name="kdproduct" value="Close" class="buttons" onclick="window.location='../include/empty.php'"></span>
 ...
 <div id="search">
        <input type="text" name="Scheme_code" value="<?php echo $_REQUEST['Scheme_code']; ?>" autocomplete='off' placeholder='Search By Code'/>
        <input type="button" class="buttonsg" onclick="productscviewajaxsearch('<?php echo $Page; ?>');" value="GO"/>
 </div>
 <div class="clearfix"></div>
