...
<?php //echo $sortorderby;
	...
	<th style="width:8%" class="rounded" onClick="srincviewajax('<?php echo $Page; ?>','<?php echo $paramsval; ?>');" >DSR Name <img src="../images/sort.png" width="13" height="13" /></th>
	<th style="width:10%" align="center">Month & Year</th>
	<th style="width:60%" align="center" nowrap="nowrap">Product Name</th>
	<th style="width:5%" align="center" nowrap="nowrap">Target Units</th>
	<th style="width:5%" align="center" nowrap="nowrap">Target Naira</th>
	<th style="width:10%" align="center" nowrap="nowrap">Date</th>
</tr>
</thead>
<tbody>
<?php
