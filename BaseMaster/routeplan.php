...
<div id="mainarea">
<div class="mcf"></div>
<div align="center" class="headingsgr">MASTER JOURNEY PLAN</div>
...
<td>
 ...
 <tr>
  ...
  <legend><strong>Master Journey Plan</strong></legend>
	  <table>
	    <tr>
		<td align="left" style="width:15%" height="28" colspan="2">SR Name*</td>
		<td align="left" style="width:65%" colspan="3">
		<select style="width:70%" class="dsrname" name="dsrname" id="dsrname" onChange="getAllRoutes(this.value);">
