...
<tr height="20">
     ...
     <td>
        ...
        <span id="srspan">
			<select class="dsrname" name="srcode" id="srcode" multiple onChange="getasmrsmsrinc(this.value);">
		...
		<td>ASM&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </td>
		<td align="left" style="width:2%" nowrap="nowrap" class="align2">
		  <span id="asmspan">
			<select class="dsrname" name="asmcode" id="asmcode" multiple onChange="getasmspecificsrinc(this.value);">
	 ...
	 <td>RSM&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </td>
	  <td align="left" nowrap="nowrap" style="width:2%" class="align2">
        <span id="rsmspan">
			<select class="dsrname" name="rsmcode" id="rsmcode" multiple onChange="getrsmspecificsrinc(this.value);">
