  ...
  <table border="1" width="100%" class="tablecls">
	<thead class="theadcls">
	  <tr>
		...
		<th align="center">Effectivity %
		 <table width="100%" ><tr><td ><strong>Target</strong></td><td> <strong>Actual</strong></td></tr></table>
		</th>
...
?>
<tr >
	 <td class="tdcls" <?php if($reportby == 'DSR_Name') { ?> style="background-color:#31859C;" <?php } ?>><?php echo ucwords(strtolower($SearchVal[DSR_Name])); ?></td>
	 <td class="tdcls" align="right" <?php if($reportby == 'DateVal') { ?> style="background-color:#31859C;" <?php } ?>><?php echo $SearchVal[DateVal]; ?></td>
