 ...
 <tr>
  ...
  <thead>
	<tr>
		...
		$paramsval	=	$DateVal."&".$DSR_Code."&".$sortorderby."&VS.Product_code"; ?>
	...
	if($num_rows >0) {
		...
		$opn_Stock					=	0;
			...
			<tr>
				...
				<td align='center'><input type='hidden' value='<?php echo $Product_code; ?>' name='product_code_<?php echo $t; ?>' /><?php if($Batch_Control == 'ON-ALL') { ?> <a href="javascript:void(0);" onclick="showBatch('<?php echo $Product_code; ?>','<?php echo $Product_name; ?>','<?php echo $UOM; ?>','<?php echo $Batch_Number; ?>','<?php echo $Expiry_Date; ?>','<?php echo $StockQty; ?>');"> <?php } ?><?php echo $Product_code; ?><?php if($Batch_Control == 'ON-ALL') { ?></a><?php } ?></td>
				...
				<td align='center'><input type='hidden' readonly value='<?php echo $Loaded_quantity; ?>' name='Loaded_Qty_<?php echo $t; ?>' /><?php echo $Loaded_quantity; ?></td>
				<td align='center'><input type='hidden' value='<?php echo $Sold_quantity; ?>' name='salequantity_<?php echo $t; ?>' /><?php echo $Sold_quantity; ?> </td>
				<td align='center'><input type='hidden' readonly value='<?php echo $Return_quantity; ?>' name='returnqty_<?php echo $t; ?>' /><?php echo $Return_quantity; ?></td>
