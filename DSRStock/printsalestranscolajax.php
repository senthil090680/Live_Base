  ...
  <tbody id="productsadded">
	...
	?> 
		<tr>
			...
			<td align='right'><?php echo number_format($Net_Sale_value,2); ?></td>
			<td align='right'><?php echo number_format($Collection_Value,2); ?></td>
			<td align='right'><?php echo number_format($Balance_Due_Value,2); ?></td>
		</tr>
	<?php } // WHILE LOOP
	} // IF LOOP
	else { ?>
