	...
	if($_POST['submit']=='Save'){
		if($Date=='' || $Transaction_number==''  || $DSR_Code	=='' || $bankcnt =='' || $Total_Amount =='')
		{
			...
			for($k=1; $k <= $bankcnt; $k++) { 
				...
				$Amount_Deposited	=	str_replace(",","",$_POST["Amount_Deposited_".$k]);
