...
<span style="float:left;"><input type="button" name="kdproduct" value="Add Cycle Start Assignment" class="buttonsbig" onclick="window.location='cycle_assignment.php'"></span><span style="float:left;padding-left:20px;"><input type="button" name="kdproduct" value="Close" class="buttons" onclick="window.location='../include/empty.php'"></span>


 <div id="search">
	<input type="text" name="DSR_name" id="DSR_name" value="<?php echo $_REQUEST['DSR_name']; ?>" autocomplete='off' placeholder='Search By SR Name'/>
	<input type="button" class="buttonsg" onclick="searchcyasviewajax('<?php echo $Page; ?>');" value="GO"/>
 </div>
 <div class="clearfix"></div>
		...
		<tr>
			...
			<td nowrap="nowrap" align="center"><?php echo $fetch[DateCycle];?></td>
