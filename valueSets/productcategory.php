...
<div class="mcf"></div>
<div><h2 align="center">Product Category</h2></div> 

<div id="container">

<div class="clearfix"></div>
 <div id="search">
        <input type="text" name="product_category" value="<?php echo $_REQUEST['product_category']; ?>" autocomplete='off' placeholder='Search By product_category'/>
        <input type="button" class="buttonsg" onclick="product_categoryviewajaxsearch('<?php echo $Page; ?>');" value="GO"/>
 </div>
 <div class="clearfix"></div>
		<div id="product_categoryid">
