...
<div class="mcf"></div>
<div><h2 align="center">Customer Category2</h2></div> 

<div id="container">

<div class="clearfix"></div>
 <div id="search">
        <input type="text" name="category2" value="<?php echo $_REQUEST['category2']; ?>" autocomplete='off' placeholder='Search By category2'/>
        <input type="button" class="buttonsg" onclick="category2viewajaxsearch('<?php echo $Page; ?>');" value="GO"/>
 </div>
 <div class="clearfix"></div>
		<div id="category2id">
