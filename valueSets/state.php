...
<div class="mcf"></div>
<div><h2 align="center">State</h2></div> 

<div id="container">

<div class="clearfix"></div>
 <div id="search">
        <input type="text" name="state" value="<?php echo $_REQUEST['state']; ?>" autocomplete='off' placeholder='Search By State'/>
        <input type="button" class="buttonsg" onclick="stateviewajaxsearch('<?php echo $Page; ?>');" value="GO"/>
 </div>
 <div class="clearfix"></div>
		<div id="stateid">
