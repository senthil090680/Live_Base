...
function locationviewajax(page,params,params2){   // For pagination and sorting of the SR view page
...
<div class="mcf"></div>
<div><h2 align="center">Location</h2></div> 

<div id="container">

<div class="clearfix"></div>
 <div id="search">
        <input type="hidden" name="lga_id" value="<?php echo $_REQUEST['lga_id']; ?>" autocomplete='off' placeholder='Search By Location'/>
        <input type="text" name="location" value="<?php echo $_REQUEST['location']; ?>" autocomplete='off' placeholder='Search By Location'/>
        <input type="button" class="buttonsg" onclick="locationviewajaxsearch('<?php echo $Page; ?>');" value="GO"/>
 </div>
 <div class="clearfix"></div>
		<div id="locationid">
