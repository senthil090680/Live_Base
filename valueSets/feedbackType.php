...
<div class="mcf"></div>
<div><h2 align="center">Feedback Type</h2></div> 

<div id="container">

<div class="clearfix"></div>
 <div id="search">
        <input type="text" name="feedback_type" value="<?php echo $_REQUEST['feedback_type']; ?>" autocomplete='off' placeholder='Search By feedbackType'/>
        <input type="button" class="buttonsg" onclick="feedback_typeviewajaxsearch('<?php echo $Page; ?>');" value="GO"/>
 </div>
 <div class="clearfix"></div>
		<div id="feedback_typeid">
