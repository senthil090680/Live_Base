 ...
 <fieldset class="alignment">
  ...
  <table>
    ...
    <tr  height="20">
     ...
     <td><?php echo $row_dsr[supplier_name]; ?></td>
   </table>
 </fieldset>
   </td>
 </tr>
...
<?php if($prvId != '') { ?>
<span style="float:left;"> <a href="javascript:void(0);" onclick="prvrecord('<?php echo $prvId; ?>','showisscontent.php');" ><img src="../images/back.png" /></a></span>
<?php } ?>
<?php if($nextId != '') { ?>
<span style="float:right;"> <a href="javascript:void(0);" onclick="nextrecord('<?php echo $nextId; ?>','showisscontent.php');" ><img src="../images/front_play.png" /></a></span>
<?php } ?>
<div id="containerpr">
        <?php
		if($_GET['id']!=''){
		...
		<tbody>
		<tr>
		<td><?php echo $row_dsr['line_number'];?></td>
