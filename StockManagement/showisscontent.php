...
<table width="50%" align="left">
 <tr>
  <td>
 <fieldset class="alignment">
  <legend><strong>DSR</strong></legend>
  <table>
    <tr  height="20">
    <td  width="120">DSR Code</td>
    <td><?php echo $row_dsr[DSR_Code]; ?>
	</td>
    </tr>
    <tr  height="20">
...
<table width="50%" align="left">
 ...
 <fieldset class="alignment">
  ...
  <table>
    <tr  height="20">
    <td  width="120">Confirmation Flag</td>
    <td><?php echo $row_dsr[confirmation_flag]; ?>
	</td>
    </tr>
    <tr  height="20">
     <td width="120">Date & Time</td>
     <td><?php echo $row_dsr[confirmation_date_time]; ?></td>
   </table>
 </fieldset>
   </td>
 </tr>
...
<table width="50%" align="left">
 <tr>
  ...
  <table>
    <tr height="20">
    <td width="120">Date  </td>
    <td style="padding-left:40px;"><?php echo $row_dsr['Date']; ?></td>
    </tr>

  <tr height="20">
    <td width="120">DSR Code </td>
    <td style="padding-left:40px;"><?php echo $row_dsr[DSR_Code]; ?>
	</td>
    </tr>
...
<table width="50%" align="left">
 <tr>
  ...
  <table>
   ...
   <tr height="20">
     <td width="120">Issue Number </td>
     <td style="padding-left:75px;"><?php echo $row_dsr['Transaction_number']; ?></td>
   </tr>
...
<table width="50%" align="left">
 <tr>
  ...
  <table>
    ...
    <td style="padding-left:40px;"><?php echo $row_dsr[confirmation_flag]; ?>
	</td>
    </tr>
   </table>
   </td>
 ...
 <tr>
  ...
  <table>
    <tr height="20">
     ...
     <td style="padding-left:40px;"><?php echo $row_dsr[confirmation_date_time]; ?></td>
	 </tr>
   </table>
   </td>
 </tr>
